                                            ...
                                            <div class="box-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <label>Waktu Void </label>
                                                                            <input type="text" name="tanggal_penjualan" class="form-control" value="<?php echo date('Y-m-d', strtotime($info[0])) ?>" readonly />
                                                                        </div>
                                                                    </div>
                                                                    <div class=" col-lg-3">
                                                                        <div class="form-group">
                                                ...
                                                <table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql_items = "SELECT jualdetil.kd_brg,
                                                        barang.nama,
                                                        jualdetil.satuan,batal_jualdetil.banyak,jualdetil.harga,jualdetil.diskon,jualdetil.jumlah,jualdetil.qty_satuan 
                                                        FROM `jualdetil` 
                                                        JOIN barang on jualdetil.kd_brg = barang.kd_brg
                                                        JOIN batal_jualdetil on batal_jualdetil.jadi = jualdetil.jadi
                                                        WHERE jualdetil.faktur = '$_GET[id]'";
                                                        ...
                                                        ?>
                                                            <tr style="<?php echo $row_style; ?>">
                                                                ...
                                                                <td style="text-align: right;"><?php echo number_format($item['banyak']); ?></td>
                                                                <td style="text-align: right;"><?php echo number_format($item['qty_satuan']); ?></td>
                                                                <td style="text-align: right;"><?php echo number_format($item['banyak'] * $item['qty_satuan']); ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
