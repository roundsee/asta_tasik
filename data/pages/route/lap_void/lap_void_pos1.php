...
?>
	...
	<?php if ($login_hash == 6 or $login_hash == 7 or $filter == 'outlet'  or $login_hash == 0  or $login_hash == 2) { ?>
		...
		<table id="example" class="table table-bordered table-striped">
			...
			<tbody>
				...
				employee.name_e as namaoleh,
				batal_penjualan.kd_cus  as p_nama,
				batal_penjualan.jumlah as p_jumlah,penjualan.b_paking
				...
				LEFT join employee on employee.employee_number = batal_penjualan.oleh
				LEFT join penjualan on penjualan.faktur = batal_penjualan.faktur
				...
				while ($s1 = mysqli_fetch_array($sql1)) {
					...
					$info = [
						$s1['tanggal'],
						$s1['namaoleh'],
						number_format($s1['p_jumlah'])
					];
					$info_query = http_build_query(['info' => $info]);

					$link = "../../main.php?route=lap_void_detil_view&act&id={$s1[$f1]}&asal={$rute}&{$info_query}";
				?>
					<tr align="left">
						<td style="width:30px"><?php echo $no; ?></td>
						<!-- <td style="width:120px"><?php echo $s1['p_nama']; ?></td> -->
						<td style="width:120px"><?php echo $namakategori; ?></td>
						<td width="120px"><a href="<?php echo $link; ?>" title="Detail"><?php echo $s1[$f1]; ?></a></td>
						<!-- <td style="width:120px"><?php echo $s1[$f1]; ?></td> -->
						<!-- <td style="width:120px"><?php echo $s1[$f6]; ?></td> -->
						<td style="width:120px"><?php echo $s1['namaoleh']; ?></td>
						<td style="width:120px"><?php echo $s1['tanggal']; ?></td>
