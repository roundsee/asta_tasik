...
$judulform = "IMPORT SAGE RETUR PEMBELIAN";
                  ...
                  <div class="box">
                    <div class="box-body">
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=import_sage_retur_beli" method="post">
                          <div class="row">
