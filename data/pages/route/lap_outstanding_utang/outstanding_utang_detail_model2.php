  ...
  <table id="example4" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      ?>
        <tr align="left">
          ...
          <td align="right"><?php echo number_format($hargatotal); ?></td>
          <td align="right">
            <a href="/data/pages/main.php?route=<?php echo $view; ?>&act&id=<?php echo $s1['no_invoice']; ?>&asal=<?php echo $rute; ?>" title="Detail" style="text-decoration: none;">
              <span style="color: #1E90FF; font-weight: bold; font-size: 16px;">
                <i class="fas fa-info-circle" style="margin-right: 5px;"></i>
                <?php echo number_format($jumlah_payment); ?>
              </span>
            </a>
          </td>

          <!-- <td><a href="main.php?route=<?php echo $view; ?>&act&id=<?php echo $s1['no_invoice']; ?>&asal=<?php echo $rute; ?>" title="Detail" style="color: bluedark;" ><?php echo number_format($jumlah_payment); ?></td> -->
          <td align="right"><?php echo number_format($sisa_tagihan); ?></td>
          <td align="right" align="right" style="background-color: #e0f7fa;"><?php echo number_format(($selisih_hari >= 0 && $selisih_hari <= 7) ? $sisa_tagihan : 0); ?></td>
          <td align="right" style="background-color: #ffe0b2;"><?php echo number_format(($selisih_hari >= 8 && $selisih_hari <= 14) ? $sisa_tagihan : 0); ?></td>
          <td align="right" style="background-color: #c8e6c9;"><?php echo number_format(($selisih_hari >= 15 && $selisih_hari <= 21) ? $sisa_tagihan : 0); ?></td>
          <td align="right" style="background-color: #ffcdd2;"><?php echo number_format(($selisih_hari > 21) ? $sisa_tagihan : 0); ?></td>
        </tr>
      <?php
        $no++;
      }
    ...
    <tfoot>
      <tr style="font-weight: bold; background-color: #D6D6D6;">
        ...
        <td align="right"><?php echo number_format($grandTotal['total']); ?></td>

        <td align="right"><?php echo number_format($grandTotal['jumlah_payment']); ?></td>
        <td align="right"><?php echo number_format($grandTotal['sisa']); ?></td>
        <td align="right" style="background-color: #e0f7fa;"><?php echo number_format($grandTotal['range_1_7']); ?></td>
        <td align="right" style="background-color: #ffe0b2;"><?php echo number_format($grandTotal['range_8_14']); ?></td>
        <td align="right" style="background-color: #c8e6c9;"><?php echo number_format($grandTotal['range_15_21']); ?></td>
        <td align="right" style="background-color: #ffcdd2;"><?php echo number_format($grandTotal['range_22_plus']); ?></td>
      </tr>
    </tfoot>
  </table>
