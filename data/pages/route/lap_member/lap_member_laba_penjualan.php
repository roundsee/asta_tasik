									...
									<div class="box">
										<div class="box-body">
											...
											<div class="wrapper" style="min-height:30%">
												<form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report-laba-penjualan" method="post">
													<div class="row">
														<div class="col-lg-2">
														...
														<div class="col-lg-2">
															...
															<!-- Filter -->
															<div class="form-group">
																<label style="margin-right: 5px;">Member : </label>
																<select data-placeholder="Cari Member" multiple class="chosen-select" name="member[]" style="width: 270px;">
																	<option value=""></option>
																	<?php
																	$query = mysqli_query($koneksi, "SELECT kd_member,nama FROM member");
																	while ($j = mysqli_fetch_array($query)) {
																		$nama = $j["nama"];
																		$kd_member = $j["kd_member"];
																	?>
																		<option value=" <?php echo $kd_member; ?>"><?php echo $kd_member . ' - ' . $nama; ?></option>
																	<?php } ?>
																</select>
															</div>
															<div class="form-group">
																<label style="margin-right: 12px;">Barang : </label>
																<select data-placeholder="Cari Barang" multiple class="chosen-select" name="barang[]" style="width: 270px;">
																	<option value=""></option>
																	<?php
																	...
																	while ($j = mysqli_fetch_array($query)) {
																		...
																		$kd_brg = $j["kd_brg"];
																	?>
																		<option value="<?php echo $kd_brg; ?>"><?php echo $kd_brg . ' - ' . $nama; ?></option>
																	<?php } ?>
																</select>
															</div>
														</div>
