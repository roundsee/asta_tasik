          ...
          <div class="container-fluid">
            <div class="card card-default">
              ...
              <div class="card-body">
                    ...
                    <div class="box">
                      <div class="box-body">
                        <div class="table-responsive">
                          ...
                          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/mutasi_bs_tambah.php'"><i class="fa fa-plus" ;></i> Tambah Barang BS</button>

                          <div style="margin:10px"></div>
                          <form action="route/<?php echo $data; ?>/update_stok_bs.php" method="post">
                ...
                SELECT SUM(qty_diajukan) AS total
                FROM mutasi_bs_detail
                WHERE id_mutasi_bs = '{$s1['id_mutasi_bs']}'
            ");
                                  $s2 = mysqli_fetch_array($sql2);
                                  $grand_total = $s2['total'];
                                ...
                                ?>
                                  <tr align="left">
                                    ...
                                    <td><?php echo $s1[$f2] . " - " . $s1['nama_lokasi']; ?></td>
                                    <td>
                                      <?php if ($s1[$f5] == 0) { ?>
