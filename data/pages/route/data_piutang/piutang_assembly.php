                    ...
                    <div class="container-fluid table-responsive card card-default card-body">
                        ...
                        <form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=submit" onsubmit="return validateForm()">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-faktur-tab" data-toggle="pill" href="#pills-faktur" role="tab" aria-controls="pills-faktur" aria-selected="true">Bahan Baku</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-uangmuka-tab" data-toggle="pill" href="#pills-uangmuka" role="tab" aria-controls="pills-uangmuka" aria-selected="false">Bahan Jadi</a>
                                </li>
                                    ...
                                    <div class="mb-5">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-8">
                                                        <label for="nomorbukti">Kode Barang</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tanggalUangMuka" class="form-control" id="tanggalUangMuka" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nilaiterima">Harga</label>
                                                    <input type="text" name="nilaiterima" class="form-control" id="nilaiterima" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="UMSudahDibayar">Satuan</label>
                                                    <input type="text" name="UMSudahDibayar" class="form-control" id="UMSudahDibayar" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="UMDibayar">Quantity</label>
                                                    <input type="text" name="UMDibayar" class="form-control" id="UMDibayar">
                                                </div>
                                                <div class="form-group">
                                                    <label for="UMSisa" style="display: none;">Nilai</label>
                                                    <input type="hidden" name="UMSisa" class="form-control" id="UMSisa" readonly>
                                                </div>
                                                <div>
                                            ...
                                            <div class="col-md-8" style="margin-left: 90px;">
                                                <!-- <h1 style="font-weight: bold;">Data Barang jadi </h1> -->
                                ...
                                <div class="tab-pane fade show active" id="pills-simpan" role="tabpanel" aria-labelledby="pills-simpan-tab">
                                    <div class="container w-25 py-3" style="width: 100%;">
                                        <table style="width: 100%;">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 1000px;">Harga Bahan Baku</td>
                                                    <td style="width: 30px;">: </td>
                                                    <td style="width: 300px;" id="jumlahfakturdibayarsimpan">0</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 1000px;">Harga Barang jadi</td>
                                                    <td style="width: 30px;">: </td>
            ...
            <script>
                ...
                function AddUMData() {
                    ...
                    if (buktites == "") {
                        ...
                        const [year, month, day] = tanggaltes.split("-");
                        const tanggalbukti = document.getElementById("tanggalUangMuka").value;
                ...
                $(document).on("click", ".modal-pilih-uangMuka", function() {
                    const bukti_kas = $(this).attr('response-faktur');
                    ...
                    $("#nilaiterima").val(nilai_faktur);
                    $("#UMSudahDibayar").val(fakturSudahDibayar);
                    const fakturSisa = nilai_faktur - fakturSudahDibayar;
                    $('#UMSisa').val(fakturSisa);
                ...
                $(document).on("click", "#cariTableUangMuka", function() {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: 'route/data_piutang/ajax_cariFaktur.php?value=' + value + '&valuesUM=' + valuesUM,
                        dataType: 'json',
                        success: function(response) {
