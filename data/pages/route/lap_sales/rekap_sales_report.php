                                    ...
                                    <div class="col-lg-10">
                                      <div class="form-group">
                                        <form method="post" action="simpan_index.php">
                                          ...
                                          <label>Kasir <span id="status_area"></span></label>
                                          <input type="text" class="form-control" nama="area" value="" required="required" id="tampil_area_nama" readonly>
      ...
      <div class="content-wrapper " style="background-color: beige;">
        ...
        <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s">
          <div class="container-fluid">
            ...
            <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/lap_sales_excel_satuan.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&filter=<?php echo $filter; ?>&nilai=<?php echo $nilai; ?>&judul=<?php echo $judul; ?>&tes=<?php echo $tes; ?>&kategori_retail_grosir=<?php echo $kategori_retail_grosir; ?>&kategori_sub_alat_bayar=<?php echo $kategori_sub_alat_bayar; ?>'"><img src="../../assets/icons/excel2.png" width="20px"> export (satuan terkecil)</button>
            ...
            <?php echo $judul3; ?>
            <br>
            Lokasi :<?php echo $kategori_retail_grosir; ?>
            <br>
            Kasir : <?php echo $tes; ?>
            <br>
