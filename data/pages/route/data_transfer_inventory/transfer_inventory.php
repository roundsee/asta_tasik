                    ...
                    <div class="box">
                      <div class="box-body">
                        <div class="table-responsive">
                          ...
                          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/transfer_inventory_tambah.php'"><i class="fa fa-plus" ;></i> Tambah Permintaan</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                              <thead style="background-color: lightgray;" class="elevation-2">
                                <tr>
                                  ...
                                  <th><?php echo $j2; ?></th>
                                  <th><?php echo $j3; ?></th>
                                  <th>Nilai Penerimaan / Pengiriman</th>
                                  <th>Total Diskon</th>
                                  <th>Total</th>
                              ...
                              <tbody>
                                ...
                                while ($s1 = mysqli_fetch_array($sql1)) {
                                  $sql2 = mysqli_query($koneksi, "SELECT *,sum(disc) as tot_disc, sum(jml*harga) as tot_price from $tabel2 WHERE nomor_pengiriman='$s1[nomor_pengiriman]' ");
