                                                    ...
                                                    <?php if ($login_hash != 21) { ?>
                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $sql1 = mysqli_query($koneksi, "SELECT $tabel.ppn , $tabel.tarif_ppn ,$tabel.status_pembelian ,$tabel.kd_beli ,$tabel.kd_po,$tabel.tujuan_kirim,
                        ...
                        <div class="col-lg-3" >
                            <div class="form-group">
                                ...
                                <select name="kd_acc2[]" class="form-control select2" style="width:100%;"  required>
                                    <option></option>
                                    <?php
                                    $produk = mysqli_query($koneksi, " SELECT kd_brg, hrg_pcs, qty_satuan1, qty_satuan2, qty_satuan3, qty_satuan4, qty_satuan5,
                                    `Box`, `Dus`, nama FROM barang WHERE kd_subgrup is null ");
