...
?>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr align="middle">
                                  ...
                                  <td><?php echo $j[$f2]; ?> </td> 
                                  <td><?php echo $j[$f3]; ?> </td> 
                                  <td><a href="main.php?route=lokasi&act=edit&ids=<?php echo $j[$f1]; ?>&asal=<?php echo $_GET['asal']; ?>" title="Edit Data"><button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-edit"></i> Edit</button></a>

                                    <!-- <a href="route/data_lokasi/aksi_lokasi.php?route=lokasi&act=hapus&id=<?php echo $j[$f1]; ?>" title="Hapus Data" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')"><button class="btn btn-danger btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-trash"></i> Hapus</button></a> -->
                                  </td>
                                </tr>
                              <?php
                              }
    ...
    case "edit":
      ...
      //edit
      $ubah = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE kd_cus  = '$_GET[ids]'");
      $u = mysqli_fetch_array($ubah);

      $sql = mysqli_query($koneksi, "SELECT * from $tabel2 where $ff1='$u[$f4]'");
      $s1 = mysqli_fetch_array($sql);

      $sql2 = mysqli_query($koneksi, "SELECT * from $tabel3 where $gg1='$u[$f5]'");
                        ...
                        <form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=edit&ids=<?php echo $u[$f1]; ?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <select name="<?php echo $f4; ?>" class="form-control" style="width:200px;height: 40px;">
                                <option value="<?php echo $u[$f4]; ?>"><?php echo $u[$f4] . ' - ' . $s1['nama']; ?></option>
                                <?php
                            ...
                            <div class="form-group">
                              ...
                              <select name="<?php echo $f5; ?>" class="form-control" style="width:200px;height: 40px;">
                                <option value="<?php echo $u[$f5]; ?>"><?php echo $u[$f5] . ' - ' . $s2['nama']; ?></option>
                                <?php
