...
$judulform = "Daftar Build from Item Assembly ";
...
?>
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report" method="post">
                          <div class="row">
                            ...
                            <div class="col-lg-3">
                              <div class="form-group">
                                <label style="margin-right: 17px; margin-bottom: 0;font-size: 18px;">
                                  <h4><b>Pilih Lokasi</b></h4>
                                </label>
                                <div class="d-flex">
                                  ...
                                  <div class="form-check mr-3">
                                    <input class="form-check-input" type="radio" name="tipe_lokasi" id="option_lokasi2" value=1316>
                                    <label class="form-check-label" for="option_lokasi2">Retail</label>
                                  </div>
                                  <div class="form-check mr-3">
                                    <input class="form-check-input" type="radio" name="tipe_lokasi" id="option_lokasi3" value=8001>
    ...
    case "report";
      ...
      if ($login_hash == '6' or $login_hash == '7' or $login_hash == '21'  or $login_hash == '0'  or $login_hash == '2') {
        $filter = 'Outlet';
        $query = mysqli_query($koneksi, "SELECT cabang_e FROM employee WHERE employee_number='$en' ");
        $q1 = mysqli_fetch_array($query);
        $nilai = $q1['cabang_e'];
        $kondisi = "AND penjualan.kd_cus='$nilai'";
        $query = mysqli_query($koneksi, "SELECT nama,kd_cus FROM pelanggan WHERE kd_cus='$nilai' ");
        $q1 = mysqli_fetch_array($query);
        $judul_nilai = $q1['nama'];

        $where_lokasi = "AND a.kd_cus = '$q1[kd_cus]'";
        if ($q1['kd_cus'] == '0000') {
          $where_lokasi = "";
        }
      ...
      $where_lokasi = "AND a.kd_cus = '$tipe_lokasi'";
      if ($tipe_lokasi == '0') {
        $where_lokasi = "";
      }
      ...
      $judul = 'Build from Item Assembly';
      ...
      <div class="content-wrapper" style="background-color: beige; max-height: 1400px!important;">
        ...
        <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s">
          <div class="container-fluid">
            ...
            <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/lap_assembly_excel.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&filter=<?php echo $filter; ?>&nilai=<?php echo $nilai; ?>&judul=<?php echo $judul; ?>&tipe_lokasi=<?php echo $tipe_lokasi; ?>'"><img src="../../assets/icons/excel2.png" width="20px"> export </button>
