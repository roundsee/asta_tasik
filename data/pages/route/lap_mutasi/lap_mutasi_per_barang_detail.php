                  ...
                  <div class="box">
                    <div class="box-body">
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report-per-barang_detail" method="post">
                          <div class="row">
                            <!-- Batas -------------- -->
                            ...
                            <div class="col-lg-2">
                              ...
                              <div class="form-group">
                                ...
                                <div>
                                  <input type="radio" name="cakup" onclick="displayResult(this.value)" value="Area"> Pilih Lokasi
                                </div> -->
                                <!-- <div>
                                        ...
                                        <form method="post" action="simpan_index.php">
                                          ...
                                          <div class="row">
                                            <div class="col-lg-7">
                                              ...
                                              <input type="text" class="form-control" required="required" id="tampil_area_kode" placeholder="Isi Kode Lokasi">
                                            </div>
                                            <div class="col-lg-5">
                                          ...
                                          <label>Lokasi <span id="status_area"></span></label>
                                          <input type="text" class="form-control" name="area" value="" required="required" placeholder="Nama Lokasi .." id="tampil_area_nama" readonly>
                                                ...
                                                <div class="table-responsive">
                                                  <table class="table table-bordered table-striped table-hover" id="table-datatable-area">
                                                    ...
                                                    <tbody>
                                                      <?php
                                                      $no = 1;
                                                      $data = mysqli_query($koneksi, "SELECT kd_cus,nama FROM pelanggan ORDER BY kd_cus ASC");
                                                      while ($d = mysqli_fetch_array($data)) {
                                                      ?>
                                                        <tr>
                                                          <td width="1%" class="text-center"><?php echo $no++; ?></td>
                                                          ...
                                                          <td><?php echo $d['nama']; ?></td>
                                                          <td width="1%">
                                                            <button type="button" class="btn btn-success btn-sm modal-pilih-area" id="<?php echo $d['kd_cus']; ?>" kode="<?php echo $d['kd_cus']; ?>" nama="<?php echo $d['nama']; ?>" data-dismiss="modal">Pilih</button>
                                                          </td>
                                                        </tr>
                                                      <?php
                                                      }
