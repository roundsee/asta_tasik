							...
							<div class="row">
									...
									<div class="box">
										<div class="box-body">
											...
											<div class="wrapper" style="min-height:30%">
												<form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report-rekap_penjualan" method="post">
													<div class="row">
														<!-- Batas -------------- -->
                                      ...
                                      <input type="radio" name="cakup" onclick="displayResult(this.value)" value="Kota"> Kota
																...
																<!-- <div>
																	<input type="radio" name="cakup" onclick="displayResult(this.value)" value="Area"> Rekap Regional
																</div>
																<div>
																	<input type="radio" name="cakup" onclick="displayResult(this.value)" value="Nasional"> Rekap Nasional
																</div>
																 -->
																<div>
                              ...
                              <div class="col-lg-3">
                              	<div class="row">
                              		...
                              		<!-- Show utk Divisi -->
                              		<!-- Elemen HTML untuk "Nasional" -->
                              		<div id="isian4">Content for Nasional</div>
        ...
        <script>
        	function displayResult(cakup) {
        		...
        		if (x == "Semua") {
        			...
        			x5.style.display = "none";
						document.getElementById("Nasional").value = "Nasional"; // Menetapkan nilai "Nasional" ke input tersembunyi
					}
					else if(x=="Unitkerja"){
						x0.style.display = "none";
						x1.style.display = "none";
