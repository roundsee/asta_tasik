...
$judulform = "Laporan Penjualan (BARANG)";
...
<table id="example4" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        //         (CASE WHEN aggregated_totals.sum_qt_jual = 0 THEN 0 ELSE aggregated_totals.sum_nilai_jual / aggregated_totals.sum_qt_jual END)
        //     ) AS sum_nilai_jual,
        //     SUM(aggregated_jualdetil.total_qty * 
        //         (CASE WHEN aggregated_totals.sum_qt_jual = 0 THEN 0 ELSE aggregated_totals.sum_hpp_jual / aggregated_totals.sum_qt_jual END)
        //     ) AS sum_hpp_jual
        // FROM $tabel
        // JOIN barang ON barang.kd_brg = $tabel.kd_brg
        // JOIN (
        ...
        //     WHERE tgl >= '$tgl_awal' AND tgl <= '$tgl_akhir'
        //     GROUP BY kd_brg
        // ) AS aggregated_totals ON aggregated_totals.kd_brg = $tabel.kd_brg
        // JOIN (
    ...
    WHERE tgl = '$tgl_akhir' AND $tabel.kd_cus = 1316
    $kondisi
    GROUP BY $tabel.kd_brg
    ORDER BY $tabel.kd_brg ASC";
