...
if (isset($_POST['faktur'])) {
    ...
    pelanggan.nama AS nama_gudang,penjualan.oleh, sum(retur_penjualan.total_retur) as total_retur,penjualan.b_paking
    FROM jualdetil 
    LEFT JOIN barang ON jualdetil.kd_brg=barang.kd_brg
    LEFT JOIN penjualan ON jualdetil.faktur=penjualan.faktur
    LEFT JOIN retur_penjualan ON jualdetil.faktur=retur_penjualan.faktur
