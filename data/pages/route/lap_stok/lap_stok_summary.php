...
$judulform = "Rangkuman Stok Terkini";
                  ...
                  <div class="box">
                    <div class="box-body">
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report-summary" method="post">
                          <div class="row">
                            <!-- Batas -------------- -->
                            <!-- <div class="col-lg-2">
                              ...
                              <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <?php if ($login_hash != '8') { ?>
                                    ...
                                    <div>
                                      <input type="radio" name="cakup" onclick="displayResult(this.value)" value="Supplier"> Pilih Lokasi
                                    </div>
                                    <!-- <div>
                                        ...
                                        <form method="post" action="simpan_index.php">
                                          <div class="row">
                                            <div class="col-lg-6">
                                              ...
                                              <input type="text" class="form-control" required="required" id="tampil_asuransi_kode" placeholder="Isi Kode Lokasi">
                                            </div>
                                            <div class="col-lg-6">
                                          ...
                                          <label>Lokasi<span id="status_asuransi"></span></label>
                                          <input type="text" class="form-control" name="supplier" value="" required="required" placeholder="Nama Lokasi .." id="tampil_asuransi_nama" readonly>
                                                ...
                                                <div class="table-responsive">
                                                  <table class="table table-bordered table-striped table-hover" id="table-datatable-kota">
                                                    ...
                                                    <tbody>
                                                      <?php
                                                      $no = 1;
                                                      $data = mysqli_query($koneksi, "SELECT kd_cus,nama
                                                                              FROM pelanggan      
                                                                              WHERE kd_cus != '0000' 
                                                                              ORDER BY kd_cus ASC;
                                                                              ");
                                                      ...
                                                      ?>
                                                        <tr>
                                                          ...
                                                          <td width="1%" class="text-center"><?php echo $d['kd_cus']; ?></td>
                                                          <td width="3%"><?php echo $d['nama']; ?></td>
                                                          <td width="1%">
                                                            <button type="button" class="btn btn-success btn-sm modal-pilih-asuransi" id="<?php echo $d['kd_cus']; ?>" kode="<?php echo $d['kd_cus']; ?>" nama="<?php echo $d['nama']; ?>" data-dismiss="modal">Pilih</button>
                                                          </td>
                                                        </tr>
                                                      <?php
                                                      }
