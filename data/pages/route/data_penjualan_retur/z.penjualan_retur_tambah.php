                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Banyak</label>
                                                <input type="text" class="form-control" name="banyak[]" value="${barang.banyak}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="${barang.nama_gudang}" readonly>
                                                <input type="hidden" class="form-control" name="kd_cus[]" value="${barang.kd_cus}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Jumlah Retur</label>
                                                <input type="number" class="form-control jumlah_retur" name="jumlah_retur[]" max="${barang.banyak}" data-max="${barang.banyak}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
