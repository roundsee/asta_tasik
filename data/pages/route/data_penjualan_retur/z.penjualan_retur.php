                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql1 = mysqli_query($koneksi, "SELECT t.$f1,t.$f2,t.$f3,p.tanggal AS tanggal_penjualan  from $tabel t
                                                            LEFT JOIN penjualan p ON t.faktur = p.faktur GROUP BY t.$f2");
                                                            $no = 1;
                                                            ...
                                                            ?>
                                                                <tr align="left">
                                                                    ...
                                                                    <td>
                                                                        <a href="main.php?route=<?php echo $rute_detail; ?>&act&id=<?php echo $s1[$f2]; ?>&asal=<?php echo $rute; ?>" title="edit Detail"> <button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;"><i class="fa fa-check"></i> Edit</button></a>
