...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
    ...
    switch ($_GET['act']) {
        default:
            ...
            $query = mysqli_query($koneksi, "SELECT p.*,pelanggan.kd_cus,pelanggan.nama AS nama_gudang,penjualan.tanggal AS tanggal_penjualan,penjualan.oleh
            FROM $tabel p
                                            ...
                                            <div class="box-body">
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label>Kasir</label>
                                                                            <input type="text" class="form-control" value="<?php echo $q1['oleh']; ?>" readonly />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="login_hash" class="form-control" value="<?php echo $q1['no_voucher']; ?>" readonly />
                                                                        </div>
                                                                    </div>
                                                ...
                                                <table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql_items = "SELECT t.kd_brg,b.nama AS nama_barang,t.satuan,t.banyak,t.total_retur,t.kd_retur,t.kd_cus,p.nama AS nama_gudang,t.faktur,t.harga
                                                        FROM $tabel t 
                                                        ...
                                                        ?>
                                                            <tr style="<?php echo $row_style; ?>">
                                                                ...
                                                                <td style="text-align: right;"><?php echo number_format($harga_retur); ?></td>
                                                                <td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right;"><strong><?php echo number_format($total_harga_retur); ?></strong></< /td>
