...
<body>
    <table id="example" class="table table-bordered table-striped">
        ...
        <tbody>
            <?php
            $sql1 = mysqli_query($koneksi, "SELECT kd_cus,kd_brg,sum(banyak*qty_satuan) as total_qty, sum(jumlah) as total_nilai FROM assembly_results WHERE DATE(tanggal) = '$tgl_awal'
        				GROUP By kd_brg");
            $no = 1;
