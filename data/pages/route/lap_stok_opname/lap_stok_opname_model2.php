  ...
  <table id="example4" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
    <thead style="background-color: #ddd;">
      <tr style="font-weight: 600">
        ...
        <th>Lokasi</th>
        <th style="text-align: left;"><?php echo $j3; ?></th>
        <th style="text-align: left;">Nama Barang</th>
        <th><?php echo $j4; ?></th>
        <th><?php echo $j5; ?></th>
        <th>Total Qty (satuan terkecil)</th>
        <th style="text-align: left;"><?php echo $j6; ?></th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      WHERE $tabel.tgl_stokopname BETWEEN '$tgl_awal' AND '$tgl_akhir'
    ");
...
<?php } elseif ($filter == 'supplier') { ?>
  ...
  <table id="example4" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      JOIN employee AS employee2 ON employee2.employee_number = $tabel.diperintahkan_oleh
      JOIN pelanggan ON pelanggan.kd_cus = $tabel.kd_cus
      WHERE $tabel.tgl_stokopname BETWEEN '$tgl_awal' AND '$tgl_akhir' AND $tabel.kd_cus = '$nilai'
    ");
    ...
    <tfoot>
      <tr style="font-weight: 600">
        <td colspan="6" align="right">Grand Total Keseluruhan</td>
        <td align="right"><?php echo number_format($grand_total); ?></td>
        <td></td>
      </tr>
    </tfoot>
