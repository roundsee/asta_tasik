...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
	...
	switch ($_GET['act']) {
		default:
			...
			$query2 = mysqli_query($koneksi, "SELECT $tabel.*,	
			employee1.name_e AS nama_input_oleh,
			employee2.name_e AS nama_diperintahkan_oleh FROM $tabel
			...
			$kd_cus = $q2['kd_cus'];
			$input_oleh = $q2['nama_input_oleh'];
			$diperintah_oleh = $q2['nama_diperintahkan_oleh'];
			...
			// Ambil data pelanggan jika ada hasil
			$pelanggan_data = mysqli_fetch_array($result);

			$kd_cus_pengirim = $pelanggan_data['kd_cus'];
														...
														<form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=edit&id=<?php echo $q1[$f1]; ?>" enctype="multipart/form-data">
															...
															<div class="row">
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		<label>Lokasi</label>
																		<input type="text" name="<?php echo $f2; ?>" class="form-control" value="<?php echo $kd_cus . '-' . $nama_pelanggan ?>" readonly />
																	</div>
																</div>
															...
															<div class="row">
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		...
																		<input type="text" name="<?php echo $f4; ?>" class="form-control" value="<?php echo $input_oleh; ?>" readonly />
																	</div>
																</div>
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		<label>Diperintahkan Oleh</label>
																		<input type="text" name="<?php echo $f5; ?>" class="form-control" value="<?php echo $diperintah_oleh; ?>" readonly />
																	</div>
																</div>
												...
												<table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
													<thead style="background-color: lightgray;" class="elevation-2">
														<tr>
															...
															<th><?php echo $j4; ?></th>
															<th><?php echo $j5; ?></th>
															<th>Total Qty (satuan terkecil)</th>
															<th><?php echo $j6; ?></th>
													...
													");
														...
														?>
															<tr align="left">
																...
																<td style="text-align:right"><?php echo $s1[$f4]; ?></td>
																<td style="text-align:right"><?php echo $s1[$f5]; ?></td>
