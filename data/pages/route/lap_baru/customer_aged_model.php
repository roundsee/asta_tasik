...
?>
    ...
    <style type="text/css">
        ...
        #example_customer_age_wrapper {
            width: 100%;
            overflow-x: auto;
        }

        #example_customer_age {
            min-width: 1800px;
            width: 100%;
            table-layout: fixed;
        }
    ...
    <?php if ($tipe_laporan == 'summary') { ?>
        <div class="table-responsive">
            ...
            <table id="example_customer_age" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    SELECT 
                        ...
                        DATEDIFF(CURDATE(), penjualan.tanggal) AS selisih_hari,
                        ...
                        penjualan.jumlah, penjualan.ongkir, penjualan.voucher_nilai_diskon, penjualan.byr_pocer
                    FROM penjualan
                    LEFT JOIN (
                    ...
                    LEFT JOIN paylater ON paylater.faktur = penjualan.faktur
                    WHERE penjualan.kd_alatbayar = 214 $supplier_filter
                    GROUP BY 
                        penjualan.faktur
                    HAVING IFNULL(SUM(paylater.jumlah_payment), 0) < (penjualan.jumlah + penjualan.ongkir - penjualan.voucher_nilai_diskon - penjualan.byr_pocer)
                    ORDER BY penjualan.faktur;
                ");
                    ...
                    ?>
                        <tr align="left">
                            <td><?php echo $no; ?></td>
                            <td style="font-weight: bold;" class="force-string"><a href="../../route/lap_baru/customer_aged_model.php?filter=semua&nilai=semua&supplier=<?php echo $array_new_supplier_string; ?>&tipe_laporan=detail&tgl_awal=<?php echo date('Y-m-d'); ?>"><?php echo $supplier; ?></td>
    ...
    <?php } else if ($tipe_laporan == 'detail') { ?>
        <div class="table-responsive">
            ...
            <table id="example_customer_age" class="table table-bordered wide-table ">
                <thead style="background-color: lightgray;" class="elevation-2">
                    <tr>
                        <th>Name</th>
                        <th>Source</th>
            ...
            ");
                    ...
                    ?>
                        ...
                        $sqlminus = mysqli_query($koneksi, "
                            SELECT paylater.jumlah_payment, paylater.faktur as no_invoice, 
                            paylater.tanggal_payment,paylater.no_payment,
                            DATEDIFF(CURDATE(), paylater.tanggal_payment) AS selisih_hari
                            FROM paylater 
                            WHERE paylater.faktur IN ($invoice_list)
                        ");
                        ...
                        ?>
                            <tr align="left" style="background-color: #dee2e6;">
                                ...
                                <td style="font-weight: bold;" class="force-string"><a href="../../main.php?route=paylater_view&act&id=<?php echo $payment['no_invoice'] ?>&asal=paylater" title="Detail"><?php echo $payment['no_payment']; ?></a></td>
    ...
    <script>
        ...
        //   $('#example_customer_age').DataTable({
        //     dom: 'Bfrtip',
        //     scrollX: true,
        //     buttons: [
