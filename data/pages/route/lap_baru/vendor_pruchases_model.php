...
if (empty($_SESSION['namauser']) and empty($_SESSION['passuser'])) {
  ...
  <center>Untuk mengakses modul, Anda harus login <br>";
    ...
    if (empty($barangsearch)) {
        $barangsearch_filter = "";
    } else {
        $barangsearch_filter = "AND pembelian_invoice_detail.kd_brg = '$barangsearch'";
    }
...
?>
    ...
    <style type="text/css">
        ...
        #example_vendor_purchases_wrapper {
            width: 100%;
            overflow-x: auto;
        }

        #example_vendor_purchases {
            min-width: 1800px;
            width: 100%;
            table-layout: fixed;
        }
    ...
    <?php if ($tipe_laporan == 'summary') { ?>
        <div class="table-responsive">
            ...
            <table id="example_vendor_purchases" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;" class="elevation-2">
                    <tr>
                        ...
                        <th class="bg1">Quantity</th>
                        <th class="bg1">Unit</th>
                        <th class="bg2">Cost Per Unit</th>
                        <th class="bg3">Total Cost</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $sql1 = mysqli_query($koneksi, "SELECT pembelian_invoice_detail.kd_brg as kode_barang, 
                        SUM(pembelian_invoice_detail.jml * pembelian_invoice_detail.jml_pcs) as quantity,
                        pembelian_invoice_detail.satuan as unit,
                        SUM(pembelian_invoice_detail.nilai / pembelian_invoice_detail.jml_pcs) AS cost,
                        SUM(pembelian_invoice_detail.nilai * pembelian_invoice_detail.jml) AS total_cost,
                        COUNT(*) AS jumlah_transaksi,
                        supplier.nama as nama_supplier,
                        pembelian_invoice.kd_supp,
                        pembelian_invoice_detail.no_invoice,
                        ...
                        LEFT JOIN supplier ON supplier.kd_supp = pembelian_invoice.kd_supp
                        LEFT JOIN barang ON barang.kd_brg = pembelian_invoice_detail.kd_brg
                        WHERE pembelian_invoice.tanggal_invoice BETWEEN '$tgl_awal' AND '$tgl_akhir' $supplier_filter
                        GROUP BY pembelian_invoice.kd_supp, pembelian_invoice_detail.kd_brg
                        ORDER BY pembelian_invoice.kd_supp ASC;");
                    ...
                    ?>
                        ...
                        foreach ($invoices as $invoice) {
                            $totaltransaksi += $invoice['jumlah_transaksi'];
                            $totaljumlahharga += $invoice['total_cost'];
                            $grandtotal += $invoice['total_cost'];
                            $array_supplierData = [];
                            $array_supplierData[] = $invoice['kd_supp'];
                        ...
                        ?>
                            <tr align="left" style="background-color: #dee2e6;">
                                ...
                                <td><?php echo $invoice['kode_barang']; ?></td>
                                <td><?php echo $invoice['nama_barang']; ?></td>
                                <td style="font-weight: bold;" class="force-string"><a href="../../route/lap_baru/vendor_pruchases_model.php?filter=semua&nilai=semua&supplier=<?php echo $array_new_supplier_string; ?>&tipe_laporan=detail&tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&barangsearch=<?php echo $invoice['kode_barang']; ?>"><?php echo $invoice['jumlah_transaksi']; ?></td>
                                <td class=" bg1" align="right"><?php echo number_format($invoice['quantity']); ?></td>
                                <td class="bg1" align="right"><?php echo $invoice['unit']; ?></td>
                                <td class="bg2" align="right"><?php echo number_format($invoice['cost']); ?></td>
                                <td class="bg3" align="right"><?php echo number_format($invoice['total_cost']); ?></td>
                            </tr>
                        <?php
                        }
                        ?>
                        <tr align="left" style="background-color: #e9ecef;">
                            ...
                            <td class="bg1" align="right"></td>
                            <td class="bg2" align="right"></td>
                            <td class="bg3" align="right"><?php echo number_format($totaljumlahharga); ?></td>
                        </tr>
                    <?php
                    }
                    ?>
            ...
            <table id="example_vendor_purchases" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $sql1 = mysqli_query($koneksi, "SELECT pembelian_invoice_detail.kd_brg as kode_barang, 
                        ...
                        pembelian_invoice_detail.satuan as unit,
                        (pembelian_invoice_detail.nilai / pembelian_invoice_detail.jml_pcs) AS cost,
                        (pembelian_invoice_detail.nilai * pembelian_invoice_detail.jml) AS total_cost,
                        supplier.nama as nama_supplier,
                        pembelian_invoice_detail.no_invoice,
                        ...
                        WHERE pembelian_invoice.tanggal_invoice BETWEEN '$tgl_awal' AND '$tgl_akhir' $supplier_filter $barangsearch_filter
                        ORDER BY pembelian_invoice.kd_supp,pembelian_invoice.tanggal_invoice ASC;");
    ...
    <script>
        ...
        //   $('#example_vendor_purchases').DataTable({
        //     dom: 'Bfrtip',
        //     scrollX: true,
        //     buttons: [
