                            ...
                            <div class="row">
                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="wrapper" style="min-height:30%">
                                                <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=example_vendor_pending_items" method="post">
                                                    <div class="row">
                                                        <!-- Batas -------------- -->
                              ...
                              <div class="form-group">
                                ...
                                <input type="hidden" name="tgl_akhir" id="tgl_akhir" value="<?php echo date('Y-m-d') ?>">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                <label style="margin-right: 17px; margin-bottom: 0;font-size: 18px;">Items : </label>
                                                                <select data-placeholder="Pilih Items" multiple class="chosen-select" name="supplier[]" style="width: 270px;">
