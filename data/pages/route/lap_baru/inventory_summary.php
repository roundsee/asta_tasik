                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="wrapper" style="min-height:30%">
                                                <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=inventory_summary" method="post">
                                                    <div class="row">
                                                        <!-- Batas -------------- -->
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select data-placeholder="Pilih Items" multiple class="chosen-select" name="barangsearch[]" style="width: 270px;">
                                                                    ...
                                                                    <?php
                                                                    $query = mysqli_query($koneksi, "SELECT kd_brg,nama FROM barang WHERE `kd_subgrup` IS NULL");
