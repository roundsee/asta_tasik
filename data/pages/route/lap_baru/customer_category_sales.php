...
$judulform = "Sales By Job Categories";
                            ...
                            <div class="row">
                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="wrapper" style="min-height:30%">
                                                <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=example_customer_category" method="post">
                                                    <div class="row">
                                                        <!-- Batas -------------- -->
                              ...
                              <div class="form-group">
                                ...
                                <input type="hidden" name="tgl_akhir" id="tgl_akhir" value="<?php echo date('Y-m-d') ?>">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                <label style="margin-right: 17px; margin-bottom: 0;font-size: 18px;">Select Job Category : </label>
                                                                <select data-placeholder="Pilih Category" multiple class="chosen-select" name="supplier[]" style="width: 270px;">
                                                                    <option value="__select_all__" selected>-- Pilih Semua --</option>
                                                                    <?php
                                                                    $query = mysqli_query($koneksi, "SELECT name_e FROM `employee` WHERE id_jabatan = 2 GROUP BY name_e ORDER BY name_e ASC;");
                                                                    while ($j = mysqli_fetch_array($query)) {
                                                                    ?>
                                                                        <option value="<?php echo $j["name_e"]; ?>"><?php echo $j["name_e"]; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
