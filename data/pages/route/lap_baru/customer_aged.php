                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="wrapper" style="min-height:30%">
                                                <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=customer_aged" method="post">
                                                    <div class="row">
                                                        <!-- Batas -------------- -->
                                ...
                                <input type="hidden" name="tgl_akhir" id="tgl_akhir" value="<?php echo date('Y-m-d') ?>">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select data-placeholder="Pilih Customers" multiple class="chosen-select" name="supplier[]" style="width: 270px;">
