...
if (empty($_SESSION['namauser']) and empty($_SESSION['passuser'])) {
  ...
  <center>Untuk mengakses modul, Anda harus login <br>";
    ...
    if (in_array('__select_all__', $supplier_array) || empty($supplier_array)) {
        ...
        $supplier_filter = "AND pembelian.kd_supp IN ($supplier_in)";
    }
...
?>
    ...
    <style type="text/css">
        ...
        #example_vendor_pending_vendor_wrapper {
            width: 100%;
            overflow-x: auto;
        }

        #example_vendor_pending_vendor {
            min-width: 1800px;
            width: 100%;
            table-layout: fixed;
        }
    ...
    <div class="table-responsive">
        ...
        <table id="example_vendor_pending_vendor" class="table table-bordered table-striped">
            <thead style="background-color: lightgray;" class="elevation-2">
                <tr>
                    <th>Name</th>
                    <th>Kode PO</th>
                    <th>Tanggal PO</th>
                    <th>Tanggal Rilis PO</th>
                ...
                ?>
                    ...
                    ?>
                        <tr align="left" style="background-color: #dee2e6;">
                            ...
                            <td><?php echo $invoice['tgl_rilis']; ?></td>
    ...
    <script>
        ...
        //   $('#example_vendor_pending_vendor').DataTable({
        //     dom: 'Bfrtip',
        //     scrollX: true,
        //     buttons: [
