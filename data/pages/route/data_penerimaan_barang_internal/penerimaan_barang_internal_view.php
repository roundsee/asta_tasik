...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
	...
	switch ($_GET['act']) {
		default:
			...
			SELECT $tabel.*, 
				   IFNULL(pbi.kode_pengiriman, 'Belum melakukan pengiriman') AS kode_pengiriman_status 
			FROM $tabel 
			LEFT JOIN pengiriman_barang_internal pbi 
				   ON pbi.kode_permintaan = $tabel.kode_permintaan
			WHERE $tabel.$f1 = '$_GET[id]'
		");
			...
			$status_permintaan = $q1['status_permintaan'];
															...
															<div class="row">
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		...
																		<input type="text" name="<?php echo $f1; ?>" class="form-control" value="<?php echo $q1['kode_pengiriman_status']; ?>" readonly />
																	</div>
																</div>
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		...
																		<input type="text" name="<?php echo $f2; ?>" class="form-control" value="<?php echo $id; ?>" readonly />
																	</div>
																</div>
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		...
																		<select name="<?php echo $f5; ?>" class="form-control" disabled>
																			<option value="1" <?= ($status_permintaan == 1) ? 'selected' : ''; ?>>Selesai</option>
																			<option value="2" <?= ($status_permintaan == 2) ? 'selected' : ''; ?>>Selesai</option>
																			<option value="0" <?= ($status_permintaan == 0) ? 'selected' : ''; ?>>Proses</option>
																		</select>
																	</div>
																</div>
												...
												<table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
													<thead style="background-color: #ddd;">
														<tr style="font-weight:600">
															...
															<td align="right">Qty Diterima</td>
													...
													<tbody>
														...
														$sql1 = mysqli_query($koneksi, "SELECT pd.*, b.nama AS nama_barang, employee.name_e as user_input
														 from penerimaan_barang_detail_internal pd
														JOIN employee ON employee.employee_number = pd.user_terima
													 	JOIN barang b ON b.kd_brg=pd.kd_barang
														JOIN penerimaan_barang_internal ON penerimaan_barang_internal.kode_penerimaan = pd.kode_penerimaan
														where penerimaan_barang_internal.kode_permintaan='$_GET[id]' ");
