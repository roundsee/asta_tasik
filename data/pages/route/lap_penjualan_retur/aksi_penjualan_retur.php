...
$tujuan = 'lap_retur_penjualan';

$data = 'lap_penjualan_retur';
$rute = 'lap_retur_penjualan';
...
if ($route == $tujuan and $act == 'report') {
    ...
    header('location:../../route/' . $data . '/lap_penjualan_retur_model2.php?filter=' . $filter . '&nilai=' . $nilai . '&tgl_awal=' . $tgl_awal . '&tgl_akhir=' . $tgl_akhir);
}
