    ...
    <div class="loading-text">
        Proses<span class="dot">.</span><span class="dot">.</span><span class="dot">.</span><span class="dot">.</span><span class="dot">.</span>
                                            ...
                                            <table id="example4" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql1 = mysqli_query($koneksi, "SELECT rp.satuan,rp.subtotal,rp.tanggal_retur,rp.kd_retur,rp.faktur,rp.kd_brg,rp.login_hash,b.nama AS nama_barang,p.nama AS nama_gudang,rp.total_retur,rp.harga,rp.faktur_voucher
            FROM retur_penjualan rp 
            LEFT JOIN barang b ON rp.kd_brg=b.kd_brg
            LEFT JOIN pelanggan p ON rp.kd_cus=p.kd_cus
            WHERE rp.status_voucher >= 1 
        ...
        ");
                                                    ...
                                                    while ($s1 = mysqli_fetch_array($sql1)) {
                                                        ...
                                                        $link = "main.php?route=lap_pb1_detil_view&act&id={$s1['faktur_voucher']}&asal=pb1";
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: bold;"><a href="main.php?route=penjualan_retur_view&act&id=<?php echo $s1['kd_retur']; ?>&asal=penjualan_retur" title="Detail"><?php echo $s1['kd_retur']; ?></td>
                                                            ...
                                                            <td style="font-weight: bold;"><a href="<?php echo $link; ?>" title="Detail"><?php echo $s1['faktur_voucher']; ?></a></td>
