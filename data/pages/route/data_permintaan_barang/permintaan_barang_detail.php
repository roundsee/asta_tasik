											...
											<div class="box-body">
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td align="left" class="kode_barang_td"><?php echo $s1[$ff4]; ?></td>
																...
																<td align="center">
																	<?php
																	if (1 == 1) { ?>
																		<a href="main.php?route=<?php echo $rute_detail; ?>&act=edit-detail&id=<?php echo $s1[$ff2]; ?>&id2=<?php echo $s1[$ff4]; ?>&id3=<?php echo $s1[$ff12]; ?>" title="edit"><button class="btn btn-xs btn-primary elevation-1" style="opacity: .7"><i class="fa fa-edit"></i></button></a>
																		<a href="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=hapus-detail&id=<?php echo $s1[$ff2]; ?>&id2=<?php echo $s1[$ff4]; ?>&id3=<?php echo $s1[$ff12]; ?>" title="Hapus Data Ini" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENTING INI ... ?')"><button class="btn btn-xs btn-danger elevation-1" style="opacity: .7"><i class="fa fa-trash"></i></button></a>
												...
												<script>
													...
													$("#save-detail").click(function() {
														...
														// STEP 1: Get all existing kode_barang from the table
														let existingKodeBarang = [];
														$("td.kode_barang_td").each(function() {
															existingKodeBarang.push($(this).text().trim());
														});

														// STEP 2: Check if any input kd_acc[] exists in the table
														for (let i = 0; i < input1.length; i++) {
															let inputKode = input1[i].value.trim();
															let inputNama = input3[i].value.trim();

															if (existingKodeBarang.includes(inputKode)) {
																alert("Kode Barang sudah ada di tabel: (" + inputKode + ") " + inputNama);
																return false; // prevent submission
															}
														}

														// STEP 3: Continue your original validation
