...
?>
  ...
  <div class="content-wrapper bg_primary_3">
    ...
    <div class="modal fade" id="refreshModal" tabindex="-1" aria-labelledby="refreshModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" style="max-width: 40%; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2);">
        <div class="modal-content" style="background: linear-gradient(145deg,rgb(36, 44, 83), #fc5c7d); color: white; border-radius: 20px; padding: 30px; font-size: 1.2rem; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.3);">
          <div class="modal-header" style="border-bottom: 2px solid rgba(255, 255, 255, 0.2);">
            <h5 class="modal-title" id="refreshModalLabel" style="font-weight: 600; font-size: 1.5rem; letter-spacing: 1px;">Refresh Halaman</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="color: white; opacity: 0.7;"></button>
          </div>
          <div class="modal-body" style="text-align: center; font-size: 1.1rem; margin-top: 20px;">
            Tolong klik tombol di bawah untuk me-refresh halaman.
          </div>
          <div class="modal-footer" style="justify-content: center; padding-top: 20px;">
            <button type="button" class="btn btn-danger" id="refreshButton" style="padding: 12px 20px; border-radius: 30px; font-weight: bold; font-size: 1rem; text-transform: uppercase; letter-spacing: 1px; background-color: #fc5c7d; border: none; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.2)';" onmouseout="this.style.transform='none'; this.style.boxShadow='none';">
              Refresh
            </button>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      if (urlParams.get("showModal") === "1") {
        ...
        const newUrl = window.location.pathname + window.location.search.replace(/(\?|&)showModal=1/, '');
